        ...
        {user && (
            <div className='col-10 col-lg-5 updateprofile'>
                <form onSubmit={handleUpdate} encType='multipart/form-data'>
                    ...
                    <div className='form-group'>
                        <label htmlFor='phonenumber_field'>Contact No</label>
                        <input type='text' id='phonenumber_field' className='form-control' value={phoneNumber} onChange={(e)=>setPhoneNumber(e.target.value)}/>
                    </div>
                    <div className='form-group'>
