            ...
            <div className='col-10 col-lg-5 updateprofile'>
                <form onSubmit={submitHandler}>
                    ...
                    <div className='form-group'>
                        ...
                        <input type='password' id='passwordCurrent_field' className='form-control' value={passwordCurrent} onChange={(e)=>setPasswordCurrent(e.target.value)}/>
                    </div>
                    <div className='form-group'>
                        <label htmlFor='new_password_field'> Update Password</label>
                        <input type='password' id='new_password_field' className='form-control' value={password} onChange={(e)=>setPassword(e.target.value)}/>
                    </div>
                    <div className='form-group'>
                        <label htmlFor='new_password_confirm_field'>Confirm Update Password</label>
                    ...
                    <button type='submit' className='btn-block py-3 password-btn'>Update Password</button>
                </form>
            </div>
        </div>
        </>
