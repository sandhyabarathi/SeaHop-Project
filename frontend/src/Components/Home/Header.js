...
const Header = () => {
  ...
  return (
    <>
      ...
      <Link to='/'><img src='/assets/logotwo.png' alt='logo' logo='logo' onClick={allproperties} /></Link>
        ...
        {!isAuthenticated && !user && (
          <Link to="/login">
            <MdPersonPin className="web_logo" style={{fontSize:'75px', cursor:'pointer', color:'green'}} />
          </Link>
        )}
