...
function App() {
  const stripePromise = loadStripe(
    "pk_test_51P245kGlt0VwPRpflDTRYHer6QvvItTIR5kdc83TeXcVhAWzDlIWzIvyVeVty4ZzItHxJK5fIVnNmgdoIg0g37JN00Z5DGfJCe"
  )
  ...
  const router = createBrowserRouter(
    ...
    createRoutesFromElements(
      //defines the routing component that matches all paths "/" and renders the Main component
      ...
      <Route path="/" element={<Main/>} id="main" exact>
        ...
        <Route id='PropertyDetails' element={<PropertyDetails/>} path='propertylist/:id' exact/>
